...
class Search {
        ...
        <div class="row">
          <div class="one-third">
            ...
            ${results.generalInfo.length > 0 ? `<ul class="link-list min-list">
                ...
                </ul>` : `<p>No general info matches your search term.</p>`}
          </div>
          <div class="one-third">
            <h2 class="search-overlay__section-title">Programs</h2>
                        ${results.programs.length > 0 ? `<ul class="link-list min-list">
                    ${results.programs.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join("")}
                </ul>` : `<p>No programs matches your search term.</p>`}
            ...
            ${results.professors.length > 0 ? `<ul class="professor-cards">
                    ${results.professors.map(item => `
                        <li class="professor-card__list-item">
                          ...
                          `).join("")}
                </ul>` : `<p>No professors matches your search term.</p>`}
          </div>
          <div class="one-third">
            <h2 class="search-overlay__section-title">Campuses</h2>
            ${results.campuses.length > 0 ? `<ul class="link-list min-list">
                    ${results.campuses.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join("")}
                </ul>` : `<p>No campuses matches your search term.</p>`}

            <h2 class="search-overlay__section-title">Events</h2>
            ${results.events.length > 0 ? `${results.events.map(item => `
                        ...
                        <div class="event-summary__content">
                          ...
                          `).join("")}` : `<p>No events matches your search term.</p>`}
          </div>
        </div>
      `);
      this.isSpinnerVisible = false;
  ...
  keyPressDispatcher(e) {
    if (e.keyCode === 83 && !this.isOverlayOpened && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(":focus")) {
      this.openOverlay();
    }
